...
@implementation TMScrollMenuView
...
- (void)layoutSubviews
{
    ...
    for (NSUInteger i = 0; i < self.itemViewArray.count; i++)
    {
        ...
        itemView.frame = CGRectMake(x, 10, width, self.scrollView.frame.size.height);
