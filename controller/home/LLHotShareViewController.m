...
@interface LLHotShareViewController ()
{
...
@implementation LLHotShareViewController
...
- (void)loadCacheData
{
    ...
    NSArray *cacheArray = [[LLAPICache sharedCache] cacheArrayWithURL:LBS_API_Share_Global
                                                               params:params
                                                                class:[LLShare class]
...
- (void)loadData
{
    ...
    [[LLHTTPRequestOperationManager shareManager]
     GETListWithURL:LBS_API_Share_Global
     parameters:@{
                  @"pageId":@(1),
                  @"size":@(20)
                  }
