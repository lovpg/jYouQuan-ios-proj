...
+(NSArray *)allPictographs {
    ...
    for (int i=0x1F300; i<=0x1F320; i++) {//太阳月亮
        [array addObject:[Emoji emojiWithCode:i]];
    }
    
    for (int i=0x1F330; i<=0x1F335; i++) {//花树
        [array addObject:[Emoji emojiWithCode:i]];
    }
    
    for (int i=0x1F337; i<=0x1F37C; i++) {//花
        [array addObject:[Emoji emojiWithCode:i]];
    }
    
//    for (int i=0x1F380; i<=0x1F393; i++) {//气球
//        [array addObject:[Emoji emojiWithCode:i]];
//    }
    
//    for (int i=0x1F3A0; i<=0x1F3C4; i++) {// 摄影机
//        [array addObject:[Emoji emojiWithCode:i]];
//    }
...
//    }
    ...
    for (int i=0x1F400; i<=0x1F445; i++) {//0x1F4FC-->1F445
