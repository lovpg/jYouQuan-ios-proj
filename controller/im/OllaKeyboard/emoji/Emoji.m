...
+ (NSArray *)mapSymbolEmotions{
    return [EmojiMapSymbols allMapSymbols];
}

+ (NSArray *)pictographsEmotions{
    return [EmojiPictographs allPictographs];
}

+ (NSArray *)transportEmotions{
    return [EmojiTransport allTransport];
}
