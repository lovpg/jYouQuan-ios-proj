...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _timeLabel.textColor = RGBACOLOR(84, 140, 204, 1);
...
-(void)layoutSubviews
{
    ...
    if (self.model.isSender) {
        ...
        frame.origin.x = self.backImageView.originX - frame.size.width;
//        frame.origin.x = _animationImageView.frame.origin.x - ANIMATION_TIME_IMAGEVIEW_PADDING - ANIMATION_TIME_LABEL_WIDHT;
        ...
        frame = _timeLabel.frame;
        frame.origin.x = self.backImageView.right + BUBBLE_VIEW_PADDING;
