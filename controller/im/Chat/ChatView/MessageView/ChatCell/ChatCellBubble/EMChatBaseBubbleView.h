...
#define BUBBLE_LEFT_IMAGE_NAME @"im_bubble_l" // bubbleView 的背景图片
...
#define BUBBLE_LEFT_INSET UIEdgeInsetsMake(14, 30, 36 , 15)
#define BUBBLE_RIGHT_INSET UIEdgeInsetsMake(14, 15, 36 , 30)
...
@property (nonatomic, strong) UIImageView *deliveredView; // 已送达
@property (nonatomic, strong) UIImageView *readView;      // 对方已读
