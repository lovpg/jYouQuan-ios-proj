...
NSString* LLCovertSQLStringValue(id value) {
    if(value == nil) value=@"";
...
NSString* LLCovertSQLNumberValue(id value) {
    if (value == nil) {
        return @"0";
    }
    return LLCovertSQLStringValue(value);
}

NSString* LLCovertSQLArrayValue(id value) {
    if (value == nil) {
        return @"[]";
    }
 ...
 */
+ (NSArray *)ignoredPropertyNamesForSqlTransform{return @[@"hash",@"superclass",@"description",@"debugDescription",@"cellHeight"];}
...
+(NSString *)sqliteType:(NSString *)fieldType{
    ...
    NSDictionary *map=@{
                        INTEGER_TYPE:@[CoreNSNumber,CoreNSInteger,CoreNSUInteger,CoreEnum_int, CoreBOOL],
                        TEXT_TYPE:@[CoreNSString,CoreNSArray],
